				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am pravin potadar</h1>
							<h5 class="text-uppercase">Frantend developer</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="#"><span>Hire Me</span></a>
								<a class="primary_btn tr-bg" href="Q:\Web Class Template Modification\satner-master\Resume\Resume.pdf"><span>Get CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						<h2>let’s <br>
							...
							myself</h2>
						<p>
							My Name is Pravin Ashok potadar 
						</p>
						<p>
							I'm Styduing in 
							Fabtech Technical Campus College Of Engineering & Reserch Sangola
							B.tech in T.Y 
				...
				<div class="offset-lg-2 col-lg-4 col-md-6">
					<div class="client-info">
						<div class="d-flex mb-50">
							...
							<span class="smll">Freshar Experience Working</span>
						</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="main_title">
						...
						<p>
							To Develope to a Website Meaking & Hosting To User Requriment 
						</p>
					</div>
				</div>
			</div>
